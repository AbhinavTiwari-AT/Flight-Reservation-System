...
public://public member functions
    ...
    int j_detail() // function declaration and definition for domestic journey
    {
        ...
        cin >> doj;
        cout << "\1.Delhi(1) \t\2.Mumbai(2) \t\3.Nagpur(3) \t\4.Banglore(4)" << endl << endl;
        ...
        if((src==1 && dest==2) || (src==2 && dest==1))//condition
        {
            ...
            cout << "\2.Fly India(2)\t14:00\t\t17:05\t\tRs.5500\t\tRefundable\n";
        ...
        else if((src==1 && dest==4) || (src==4 && dest==1))//condition
        {
            ...
            cout << "\2.Fly India(2)\t14:00\t\t17:05\t\tRs.4250\t\tRefundable\n";
        ...
        else if((src==2 && dest==3) || (src==3 && dest==2))//condition
        {
            ...
            cout << "\2.Fly India(2)\t14:00\t\t17:05\t\tRs.2500\t\tRefundable\n";
        ...
        else if((src==2 && dest==4) || (src==4 && dest==2))//condition
        {
            ...
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Qantas(1)\t08:00\t\t11:05\t\tRs.5000\t\tRefundable\n";
            cout << "\2.Fly India(2)\t14:00\t\t17:05\t\tRs.4500\t\tRefundable\n";
            cout << "\3.Go Air(3)\t19:00\t\t22:05\t\tRs.6000\t\tRefundable\n";
        }
        else if((src==3 && dest==4) || (src==4 && dest==3))//condition
         {
            ...
            cout << "\2.Fly India(2)\t14:00\t\t17:05\t\tRs.5508\t\tRefundable\n";
    ...
    {   cout << "\nEnter your choice" << endl;
        ...
        switch(choice) // switch case
        {
          ...
          case 2://condition
                cout << "\nFlight selected:"<<endl;
                cout << "Fly India"<<endl;
                strcpy(f_d,"Fly India");//copy to string
...
public://public member functions
    ...
    int j_detaili()// function declaration and definition for journey details
    {
        ...
        cin >> doji;
        cout << "\1.Singapor(1) \2.Canada(2) \3.Germany(3) \4.Dubai(4) \5.Japan(5) " << endl << endl;
        cout << "\tEnter Source" << endl;
        cin >> srci;
        cout << "\nEnter destination" ;
        cin >> desti;
        ...
        if((srci==1 && desti==3) || (srci==3 && desti==1))//condition
        {
            ...
            cout << "\2.Fly India(2)\t14:00\t\t18:05\t\tRs.21500\tRefundable\n";
        ...
        else if((srci==1 && desti==4) || (srci==4 && desti==1))//condition
        {
            ...
            cout << "\2.Fly India(2)\t14:00\t\t18:05\t\tRs.21300\tRefundable\n";
        ...
        else if((srci==1 && desti==5) || (srci==5 || desti==1))//condition
        {
            ...
            cout << "\2.Fly India(2)\t14:00\t\t18:05\t\tRs.59420\tRefundable\n";
        ...
        else if((srci==2 && desti==3) || (srci==3 && desti==2))//condition
        {
            ...
            cout << "\2.Fly India(2)\t14:00\t\t18:05\t\tRs.14900\tRefundable\n";
        ...
        else if((srci==2 && desti==4) || (srci==4 && desti==2))//condition
        {
            ...
            cout << "\2.Fly India(2)\t14:00\t\t18:05\t\tRs.38500\tRefundable\n";
        ...
        else if(srci==2 && desti==5 || (srci==5 && desti==2))//condition
        {
            ...
            cout << "\2.Fly India(2)\t14:00\t\t18:05\t\tRs.87550\tRefundable\n";
    ...
    int select_flighti()//function declaration and definition for selecting flight
    {
        ...
        case 2://condition
               cout << "\nFlight selected:" << endl;
               cout << "Fly India" << endl;
               strcpy(f_i,"Fly India");//copy to string
               cout << "Departure Time: 14:00" << endl;
...
public://public members functions
    ...
    {     cout << "\n\n\nHow would you like to pay?:\n";
        ...
        case 2://condition
            ...
            break;
        case 3://condition
            cout << "Banks Available: \1.sbi Bank(1) \2.Hdfc Bank(2) \3.icic Bank(3) \4.post Bank(4) \5.Others(5)";
            cout << "\nSelect your bank:";
            cin >> bank;
